  ...
  return {
    ...
    destinations: [{
      ...
      transferPlan: {
        ...
        fallbackPlan: {
          message: 'The emergency operator could not take the call. You are back with Sarah; no emergency services have been contacted.',
